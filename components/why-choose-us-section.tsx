...
export default function WhyChooseUsSection() {
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Muy profesionales y transparentes. Recomiendo totalmente invertir con ellos.",
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "La mejor decisión de inversión que he tomado. Excelente comunicación durante todo el proceso.",
        ...
        <div className="grid gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              Somos líderes en desarrollo urbano con un historial comprobado de
              éxito.
            </p>
            <p className="text-gray-600">
              Nuestros proyectos combinan ubicación estratégica, calidad
              superior y transparencia total, asegurando resultados
              excepcionales para cada inversor.
            </p>
          </div>
