        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b pb-5">
              <Button onClick={() => handleWhatsAppSubmit(`Quiero saber mas sobre el emprendimiento ${property.name}`)} className="w-full !bg-brand-black hover:!bg-brand-black/10 gap-1">
